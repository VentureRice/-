...
```{r}
#读取数据
data_soccer1 = read.csv("~/Desktop/data_soccer0.csv")
#读取球队排名
rank = read.xlsx("~/Desktop/FinalProject/联赛排名.xlsx")
...
ggplot(data_soccer)+
  geom_boxplot(aes(x=reorder(联赛,X=身价,FUN=mean),y=身价,fill=是否为欧盟),varwidth = T)+#绘制箱线图
...
#添加年龄段标签
data_soccer[which(data_soccer$Age<=20),]$Age_tag="(0,20]"
data_soccer[which(data_soccer$Age>=35),]$Age_tag="(35,40]"
data_soccer[which(data_soccer$Age<=23&data_soccer$Age>20),]$Age_tag="(20,23]"
data_soccer[which(data_soccer$Age<=25&data_soccer$Age>23),]$Age_tag="(23,25]"
data_soccer[which(data_soccer$Age<=28&data_soccer$Age>25),]$Age_tag="(25,28]"
data_soccer[which(data_soccer$Age<=30&data_soccer$Age>28),]$Age_tag="(28,30]"
data_soccer[which(data_soccer$Age<=35&data_soccer$Age>30),]$Age_tag="(30,35]"
#绘制各年龄段身价箱线图
ggplot(data_soccer[which(is.na(data_soccer$Age_tag)==F),])+
  geom_boxplot(aes(x=Age_tag,y=身价),varwidth = T,fill=c(rep("grey",3),rep("gold",1),rep("grey",3)))+
  theme_bw(base_family = "SimSun")+
  scale_y_log10()+#对y轴坐标变换
  theme(panel.border = element_blank(),
        panel.grid.major = element_blank(),
...
data_soccer$rank_tag = "[1,25]"
data_soccer[which(data_soccer$名次<=50&data_soccer$名次>25),]$rank_tag = "(25,50]"
data_soccer[which(data_soccer$名次<=75&data_soccer$名次>50),]$rank_tag = "(50,75]"
data_soccer[which(data_soccer$名次<=100&data_soccer$名次>75),]$rank_tag = "(75,100]"
data_soccer[which(data_soccer$名次<=125&data_soccer$名次>100),]$rank_tag = "(100,125]"
data_soccer[which(data_soccer$名次<=150&data_soccer$名次>125),]$rank_tag = "(125,150]"
data_soccer[which(data_soccer$名次>150),]$rank_tag = "(150,200]"


ggplot(data_soccer[which(is.na(data_soccer$rank_tag)==F & data_soccer$名次<150),])+
  geom_boxplot(aes(x = factor(rank_tag,levels = c("[1,25]","(25,50]","(50,75]","(75,100]","(100,125]","(125,150]","(150,200]")),y=身价),fill=c(rep("gold",1),rep("grey",5)))+
  theme_bw(base_family = "SimSun")+
  scale_y_log10()+
  theme(panel.border = element_blank(),
        panel.grid.major = element_blank(),
...
AIC_coe$per = exp(AIC_coe$Estimate)
